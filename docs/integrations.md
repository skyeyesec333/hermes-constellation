...
| Conference lead capture + Project Manager sync | Supported now | Card + encounter note → review-only drafts + Obsidian Project Manager lead task (kanban/gantt notes) | Local; no auto-send; Project Manager is the CRM UI |
